package com.company.employeemanagementrestapi.config;
...
@EnableJpaRepositories(
        basePackages = "com.company.employeemanagementrestapi.data.repository",
...
public class DatabaseConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean entityManager() {
        ...
        em.setPackagesToScan("com.company.employeemanagementrestapi.data.entity");
